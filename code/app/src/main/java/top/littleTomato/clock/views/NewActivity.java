...
import top.littleTomato.clock.adpter.ChoosePriorityAdapter;
...
//            View decorView = mToolbar;
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.fab) {
            ...
            Intent intent = new Intent(NewActivity.this, ClockActivity.class);
